...
class EuclidianDistanceTest(unittest.TestCase):
    ...
    def testRunMultipleObjective(self):
        expectedReturn = {'Patron->FT': ['Patron', 'RuaPaschoalMarmo', 'FT'],
                          'FT->ShoppingNacoesLimeira': ['FT', 'RuaPaschoalMarmo', 'Patron', 'RodoviaLimeira-Piracicaba',
                                                        'ShoppingNacoesLimeira'],
                          'ShoppingNacoesLimeira->Estadio': ['ShoppingNacoesLimeira', 'RodoviaLimeira-Piracicaba',
                                                             'Patron', 'RuadaBoaMorte', 'Rodoviaria', 'RuaAugustoJorge',
                                                             'Estadio'],
        ...
        self.assertDictEqual(solution, expectedReturn)
